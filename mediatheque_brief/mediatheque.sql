...
CREATE TABLE `adherent` (
  `code_adh` int(11) NOT NULL KEY PRIMARY AUTO_INCREMENT,
...
CREATE TABLE `emprunt` (
  `code_emprunt` int(11) NOT NULL KEY PRIMARY  AUTO_INCREMENT,
...
CREATE TABLE `gerant` (
  `code_gerant` int(11) NOT NULL KEY PRIMARY  AUTO_INCREMENT,
...
CREATE TABLE `ouvrage` (
  `code_ouv` int(11) NOT NULL KEY PRIMARY AUTO_INCREMENT,
...
CREATE TABLE `reservation` (
  `code_reservation` int(11) NOT NULL KEY PRIMARY  AUTO_INCREMENT,
